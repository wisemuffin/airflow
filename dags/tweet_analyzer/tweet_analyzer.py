...
with DAG(
    ...
    etl_tweets = S3FileTransformOperator(
        ...
        dest_s3_key='s3://{S3_BUCKET}/cleaned_tweet_data.' + timestamp,
        replace=True,
    ...
    get_sentiment = S3FileTransformOperator(
        ...
        source_s3_key='s3://{S3_BUCKET}/cleaned_tweet_data.' + timestamp,
        dest_s3_key='s3://{S3_BUCKET}/analyzed_tweet_data_' + \
        timestamp + '.json',
        replace=True,
    ...
    summarize_sentiment = S3FileTransformOperator(
        ...
        source_s3_key='s3://{S3_BUCKET}/analyzed_tweet_data_' + \
        timestamp + '.json',
        dest_s3_key='s3://{S3_BUCKET}/sentiment_results_' + \
        timestamp + '.json',
        replace=True,
    ...
    #     s3_key='s3://{S3_BUCKET}/sentiment_results_' + timestamp + '.json',
    #     json_key='results'
    # )
    ...
    tweets_to_s3 >> etl_tweets >> get_sentiment >> summarize_sentiment
